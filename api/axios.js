...
const getBaseUrl = () => {
  ...
  if (Platform.OS === "android") {
    const guessedAndroidUrl = Constants.isDevice ? "http://172.16.16.178:8081" : "http://10.0.2.2:8081";
    console.log(`[API] Android detected - no configured URL found, using fallback: ${guessedAndroidUrl}`);
    return guessedAndroidUrl;
  }

  if (Platform.OS === "ios") {
    const guessedIosUrl = Constants.isDevice ? "http://172.16.16.178:8081" : "http://localhost:8081";
