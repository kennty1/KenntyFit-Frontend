...
} from "react-native";import { useTheme } from "../../context/ThemeContext";import { useAuth } from "../../context/AuthContext";
...
export default function Progress() {
  ...
  const styles = useMemo(() => StyleSheet.create({
    ...
    toggleBtn: { paddingHorizontal: 16, paddingVertical: 8, borderRadius: 8, borderWidth: 1, borderColor: theme.border },
    ...
    glanceCard: { backgroundColor: theme.accent, borderRadius: 14, padding: 18, marginBottom: 20 },
    glanceTitle: { fontSize: 14, fontWeight: "700", color: theme.accentText, marginBottom: 14 },
    glanceRow: { flexDirection: "row", justifyContent: "space-around" },
    glanceStat: { alignItems: "center" },
    glanceValue: { fontSize: 22, fontWeight: "800", color: theme.accentText },
    glanceLabel: { fontSize: 10, color: `rgba(${theme.accentText === "#fff" ? "255,255,255" : "0,0,0"},0.8)`, marginTop: 2, textTransform: "uppercase" },
    statsGrid: { flexDirection: "row", flexWrap: "wrap", gap: 10, marginBottom: 20 },
    statCard: { backgroundColor: theme.surface, borderRadius: 12, padding: 14, width: "47%", borderWidth: 1, borderColor: theme.border },
    statValue: { fontSize: 24, fontWeight: "800", marginBottom: 4, color: theme.text },
    statLabel: { fontSize: 10, color: theme.muted, textTransform: "uppercase" },
    chartCard: { backgroundColor: theme.surface, borderRadius: 14, padding: 16, marginBottom: 20, borderWidth: 1, borderColor: theme.border },
    sectionTitle: { fontSize: 12, fontWeight: "700", color: theme.text, textTransform: "uppercase", letterSpacing: 1, marginBottom: 14 },
    goalsCard: { backgroundColor: theme.surface, borderRadius: 14, padding: 16, marginBottom: 20, borderWidth: 1, borderColor: theme.border },
    goalRow: { marginBottom: 16 },
    goalInfo: { flexDirection: "row", justifyContent: "space-between", marginBottom: 6 },
    goalName: { fontSize: 13, fontWeight: "600", color: theme.text },
    goalNumbers: { fontSize: 11, color: theme.muted },
    goalBarBg: { height: 6, backgroundColor: theme.border, borderRadius: 3, overflow: "hidden", marginBottom: 4 },
    goalBarFill: { height: "100%", borderRadius: 3, backgroundColor: theme.accent },
    goalPct: { fontSize: 11, fontWeight: "700", textAlign: "right", color: theme.accent },
    insightCard: { backgroundColor: theme.surface, borderRadius: 14, padding: 16, borderWidth: 1, borderColor: theme.border },
    insightText: { fontSize: 13, color: theme.muted, lineHeight: 22 },
  }), [theme]);
