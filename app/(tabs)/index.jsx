...
export default function Dashboard() {
  ...
  const styles = useMemo(() => StyleSheet.create({
    ...
    statIcon: { width: 24, height: 24, marginBottom: 6, resizeMode: "contain" },
      ...
      >
        ...
        <View style={styles.statsGrid}>
          <View style={[styles.statCard, { borderTopColor: "#00e5a0" }]}>
            <Image source={require("../../assets/icons/water-stat.svg")} style={styles.statIcon} />
          ...
          <View style={[styles.statCard, { borderTopColor: "#0099ff" }]}>
            <Image source={require("../../assets/icons/steps.svg")} style={styles.statIcon} />
          ...
          <View style={[styles.statCard, { borderTopColor: "#ff6b6b" }]}>
            <Image source={require("../../assets/icons/calories.svg")} style={styles.statIcon} />
          ...
          <View style={[styles.statCard, { borderTopColor: "#fbbf24" }]}>
            <Image source={require("../../assets/icons/food.svg")} style={styles.statIcon} />
